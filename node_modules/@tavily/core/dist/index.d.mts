...
type TavilyResearchFunction = (input: string, options?: TavilyResearchOptions) => Promise<TavilyResearchResponse | AsyncGenerator<Buffer, void, unknown>>;
type TavilyGetResearchFunction = (requestId: string) => Promise<TavilyGetResearchResponse | TavilyGetResearchIncompleteStatusResponse>;
type TavilyClient = {
...
type TavilyGetResearchIncompleteStatusResponse = Pick<TavilyGetResearchResponse, "requestId" | "status" | "responseTime">;
 ...
 */
declare class TavilyKeylessLimitError extends Error {
    readonly capType: string;
    readonly retryAfter: number | null;
    readonly bonusEligible: boolean;
    readonly continuationPaths: TavilyContinuationPath[];
    constructor(params: {
        message: string;
        capType: string;
...
declare function isKeylessLimitEnvelope(data: any): boolean;
declare function keylessLimitErrorFromEnvelope(data: any): TavilyKeylessLimitError;

export { type TavilyClient, type TavilyClientOptions, type TavilyContextSearchFuncton, type TavilyContinuationPath, type TavilyCrawlFunction, type TavilyCrawlOptions, type TavilyCrawlResponse, type TavilyExtractFunction, type TavilyExtractOptions, type TavilyExtractResponse, type TavilyGetResearchFunction, type TavilyGetResearchIncompleteStatusResponse, type TavilyGetResearchResponse, TavilyKeylessLimitError, type TavilyMapFunction, type TavilyMapOptions, type TavilyMapResponse, type TavilyProxyOptions, type TavilyQNASearchFuncton, type TavilyRequestConfig, type TavilyResearchFunction, type TavilyResearchOptions, type TavilyResearchResponse, type TavilySearchFuncton, type TavilySearchOptions, type TavilySearchResponse, isKeylessLimitEnvelope, keylessLimitErrorFromEnvelope, tavily };
